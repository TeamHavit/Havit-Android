...
object CustomWebView {
    ...
    private fun createPendingIntent(context: Context,actionSourceId: Int): PendingIntent {
        val actionIntent = Intent(
            context.getApplicationContext(), ActionBroadcastReceiver::class.java
        )
